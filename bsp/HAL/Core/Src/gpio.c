...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : CAMERA_CAPUTRER_Pin */
  GPIO_InitStruct.Pin = CAMERA_CAPUTRER_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(CAMERA_CAPUTRER_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : BULLET_CHECKER_Pin */
  GPIO_InitStruct.Pin = BULLET_CHECKER_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(BULLET_CHECKER_GPIO_Port, &GPIO_InitStruct);
